...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/02/01 20:42:48 by sbratche          #+#    #+#             */
/*   Updated: 2018/02/01 20:42:50 by sbratche         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_process_unsigned(t_struct *print, intmax_t *nbr,
													char *str, int *chars_ret)
{
	...
	str = ft_itoa_base_unsigned(*nbr, 10, 0);
	free_str = str;
	if (str[0] == '0' && DOT)
		str = ft_strnew(0);
	len = ft_strlen(str);
